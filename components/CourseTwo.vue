        ...
        <div class="course-one__carousel owl-carousel owl-theme">
          <div class="item">
            <div class="course-one__single color-1">
              <div class="course-one__image">
                <img src="/assets/images/courses/p1.jpg" alt="" />
              ...
              <div class="course-one__content">
                ...
                <h2 class="course-one__title">
                  <a href="/course-details">Random</a>
                </h2>
                <!-- /.course-one__title -->
                ...
                <div class="course-one__meta">
                  <a href="/course-details"
                    ><i class="far fa-clock"></i> 10 Hours</a
                  >
                  <a href="/course-details"
                    ><i class="far fa-folder-open"></i> 6 Lectures</a
                  >
          ...
          <div class="item">
            <div class="course-one__single color-2">
              <div class="course-one__image">
                <img src="/assets/images/courses/p2.jpg" alt="" />
                <i class="far fa-heart"></i
                ><!-- /.far fa-heart -->
              </div>
              <!-- /.course-one__image -->
          ...
          <div class="item">
            <div class="course-one__single color-3">
              <div class="course-one__image">
                <img src="/assets/images/courses/p3.jpg" alt="" />
                <i class="far fa-heart"></i
                ><!-- /.far fa-heart -->
              </div>
              <!-- /.course-one__image -->
