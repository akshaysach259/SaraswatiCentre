<template>
  <div class="banner-wrapper">
    <section
      class="banner-one banner-carousel__one no-dots owl-theme owl-carousel"
    >
      <div class="banner-one__slide banner-one__slide-one">
        <div class="container">
          ...
          <!-- /.banner-one__bubble- -->
          <img src="/assets/images/b1.jpg" alt="" class="banner-one__scratch" />
          <img
            src="/assets/images/slider-1-person-1.png"
            class="banner-one__person"
            alt=""
          />
    ...
    <div class="banner-one__cta">
      <div class="banner-one__cta-icon">
        <i
          class="kipso-icon-black-graduation-cap-tool-of-university-student-for-head"
        ></i>
