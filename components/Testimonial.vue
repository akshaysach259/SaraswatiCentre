<template>
  <section class="testimonials-one testimonials-one__home-three">
    <div class="container">
      ...
      <div class="testimonials-one__carousel owl-carousel owl-theme">
        <div class="item">
          <div class="testimonials-one__single">
            ...
            />
            <h3 class="testimonials-one__name">Anne Hall</h3>
        ...
        <div class="item">
          <div class="testimonials-one__single">
            ...
            <img
              ...
              class="testimonials-one__img"
            />
            <h3 class="testimonials-one__name">Andre Obrien</h3>
            <!-- /.testimonials-one__name -->
            <p class="testimonials-one__designation">Student</p>
            <!-- /.testimonials-one__designation -->
          </div>
        ...
        <div class="item">
          <div class="testimonials-one__single">
            ...
            <img
              ...
              class="testimonials-one__img"
            />
            <h3 class="testimonials-one__name">Shane Vasquez</h3>
            <!-- /.testimonials-one__name -->
            <p class="testimonials-one__designation">Student</p>
            <!-- /.testimonials-one__designation -->
          </div>
        ...
        <div class="item">
          <div class="testimonials-one__single">
            ...
            <img
              ...
              class="testimonials-one__img"
            />
            <h3 class="testimonials-one__name">Maud Lee</h3>
            <!-- /.testimonials-one__name -->
            <p class="testimonials-one__designation">Student</p>
            <!-- /.testimonials-one__designation -->
          </div>
        ...
        <div class="item">
          <div class="testimonials-one__single">
            ...
            <img
              ...
              class="testimonials-one__img"
            />
            <h3 class="testimonials-one__name">Barbara Kennedy</h3>
            <!-- /.testimonials-one__name -->
            <p class="testimonials-one__designation">Student</p>
            <!-- /.testimonials-one__designation -->
          </div>
        ...
        <div class="item">
          <div class="testimonials-one__single">
            ...
            <img
              ...
              class="testimonials-one__img"
            />
            <h3 class="testimonials-one__name">Duane Carter</h3>
            <!-- /.testimonials-one__name -->
            <p class="testimonials-one__designation">Student</p>
            <!-- /.testimonials-one__designation -->
          </div>
        ...
        <div class="item">
          <div class="testimonials-one__single">
            ...
            <img
              ...
              class="testimonials-one__img"
            />
            <h3 class="testimonials-one__name">Sally Green</h3>
            <!-- /.testimonials-one__name -->
            <p class="testimonials-one__designation">Student</p>
            <!-- /.testimonials-one__designation -->
          </div>
        ...
        <div class="item">
          <div class="testimonials-one__single">
            ...
            <img
              ...
              class="testimonials-one__img"
            />
            <h3 class="testimonials-one__name">Iva Santos</h3>
            <!-- /.testimonials-one__name -->
            <p class="testimonials-one__designation">Student</p>
            <!-- /.testimonials-one__designation -->
          </div>
        ...
        <div class="item">
          <div class="testimonials-one__single">
            ...
            <img
              ...
              class="testimonials-one__img"
            />
            <h3 class="testimonials-one__name">Max Burns</h3>
            <!-- /.testimonials-one__name -->
            <p class="testimonials-one__designation">Student</p>
            <!-- /.testimonials-one__designation -->
          </div>
      ...
      <!-- /.testimonials-one__carousel owl-carousel owl-theme -->
    </div>
    <!-- /.container -->
  </section>
</template>
